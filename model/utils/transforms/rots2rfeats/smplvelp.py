...
from model.utils.temos_utils import matrix_to, nfeats_of, to_matrix
import model.utils.geometry as geometry
...
class SMPLVelP(Rots2Rfeats):
    ...
    def inverse(self, features):
        ...
        from model.utils.transforms.smpl import RotTransDatastruct
