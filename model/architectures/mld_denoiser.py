...
from model.ldm.models.architectures.tools.embeddings import (TimestepEmbedding,
                                                       Timesteps)
from model.ldm.models.operator import PositionalEncoding
from model.ldm.models.operator.cross_attention import (SkipTransformerEncoder,
                                                 TransformerDecoder,
...
class MldDenoiser(nn.Module):
    ...
    def forward(self,
        ...
        if self.arch == "trans_enc":
            ...
            print(sample.shape, emb_latent.shape)
